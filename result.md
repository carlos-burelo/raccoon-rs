...
Running test: .\tests\test_anonymous_classes.rcc
=== ANONYMOUS CLASSES TESTS ===
...
24
256
Test 4: Anonymous class reusable
50
30
12
14
...
5000
true
Test 6: Anonymous class complex
John Doe - Account: 12345
1000
700
700
=== ALL TESTS COMPLETED ===
Running test: .\tests\test_anonymous_functions.rcc
=== ANONYMOUS FUNCTIONS TESTS ===

Test 1: Simple anonymous function with block
✓ add(5, 3) = 8

Test 2: Anonymous function with parameters
✓ multiply(4, 5) = 20

Test 3: Anonymous function without parameters
✓ greet() = Hello, World!

Test 4: Anonymous function returning function
✓ make_double()(10) = 20

Test 5: Anonymous functions in data structure
✓ operations: add=15, subtract=5, multiply=50

Test 6: Array of anonymous functions
✓ functions[0](5)=10, functions[1](5)=15, functions[2](5)=0
...
[9] INTERFACES & TYPE ALIASES
  ...
  ✓ Interface extends: { name: Alice, age: 30 }
...
[7] OBJECTS & MAPS
  ...
  ✓ Computed property: 20
  ✓ Object shorthand: { propY: 200, propX: 100 }
  ✓ Nested object: 42
...
AllSettled mixto: [{ status: fulfilled, value: 10 }, { status: rejected, reason: Error en medio }, { value: 30, status: fulfilled }]
Resultado 1: { status: fulfilled, value: 10 }
Resultado 2: { status: rejected, reason: Error en medio }
...
Todas rechazadas: Future rejected: Error 1
...
Combined object: { c: 3, b: 2, d: 4, a: 1 }
Override: { x: 1, y: 99 }
...
[11] GENERICS
  ✓ Generic function: 42, hello
Running test: .\tests\test_pattern_matching.rcc
=== PATTERN MATCHING TESTS ===
Test 1: Wildcard pattern
matched
Test 2: Variable pattern
20
Test 3: Multiple arms
two
Test 4: List pattern
6
Test 5: Wildcard in list
4
Test 6: Object pattern
30
Test 7: Nested list pattern
10
Test 8: Match returns value
30
Test 9: Object pattern binding
Alice
Test 10: Default arm
many
Test 11: Empty list pattern
empty
Test 12: Complex nested
9
=== ALL TESTS COMPLETED ===
Running test: .\tests\test_pattern_matching_exhaustive.rcc
...
TEST 3: Wildcards (must be last)
  42 with single wildcard => any
  99 with one literal and wildcard => any
  77 with two literals and wildcard => any
  55 with three literals and wildcard => any
...
TEST 6: List Patterns - Wrong Length Falls Through
  [1, 2] does not match [a] => 999
  [1] does not match [a, b] => 888
  [1, 2, 3] does not match [a, b] => 777

TEST 7: List Patterns - Wildcards Inside
  [1, 2, 3] with [a, _, c] => 4
  [5, 6, 7, 8] with [a, _, c, _] => 12
  [10, 20, 30] with [_, b, _] => 20
  [1, 2, 3, 4, 5] with [a, _, _, _, e] => 6

TEST 8: Empty Lists
  [] matches [] => empty
  [1] does not match [] => not empty
  [] does not match [a] => no element
...
TEST 10: Object Patterns - Custom Binding Names
  {name: "Alice"} with {name: n} => Alice
  {first: "John", last: "Doe"} => John Doe
  {x: 100, y: 200} with {x: a, y: b} => -100
...
TEST 12: Nested Patterns - Object with Lists
  {items: [1, 2, 3]} => 6
  {data: [10, 20], count: 2} => 32
  {matrix: [[1, 2], [3, 4]]} => 5

TEST 13: Multiple Arms - Literal Priority (first match wins)
  2 matches first 2 => two
  3 matches 3 => three
  5 matches default => default

TEST 14: Complex Nested - Mixed Patterns
  Complex object with users list => 2
  Data list with meta object => 7

TEST 15: All Literal Arms (must match or error)
  1 with literals only => match
  2 with literals only => match
  3 with literals only => match

TEST 16: Mixed Literals and Variables
  5 does not match 1 => 10
  10 does not match 1 or 2, matches variable => 110
...
Pattern types tested:
  ...
  ✓ List patterns (wrong length fallthrough)
  ✓ Wildcards inside lists
  ✓ Empty lists
  ✓ Object patterns
  ✓ Object binding names
  ✓ Nested lists
  ✓ Nested objects with lists
  ✓ Multiple arms with priority
...
Testing Generics...
  ✓ Generic function: 42, hello
  ✓ Generic class: 42, boxed
  ✓ Generic interface: { first: 42, second: answer }
  ✓ Generic constraints: 3
...
Running test: .\tests\test_class_rest.rcc
In static method, args: hello
Spread operator can only be applied to arrays at position (4, 22) in file Some(".\\tests\\test_class_rest.rcc")
Got value: Str(StrValue { value: "hello" })
Full call expression: CallExpr { callee: Identifier(Identifier { name: "native_print", position: (4, 9) }), args: [Spread(SpreadExpr { argument: Identifier(Identifier { name: "args", position: (4, 25) }), position: (4, 22) })], named_args: {}, position: (4, 9) }
Running test: .\tests\test_complete_syntax_semantics.rcc
╔════════════════════════════════════════════════════════════════╗
║     RACCOON COMPLETE SYNTAX & SEMANTICS TEST                  ║
╚════════════════════════════════════════════════════════════════╝
...
Test 4: Default Import + Named Imports
  ...
  ✓ Default + named imports working

Test 5: Class Imports and Instantiation
  Initial value: 10
  After add(5): 15
  After multiply(2): 30
  After reset(): 0
  ✓ Class imports working
...
Test 7: Export List Imports
  MAX_SIZE = 100
  MIN_SIZE = 1
  validateSize(50) = true
  validateSize(200) = false
  ✓ Export list working

Test 8: Multiple Constants Import
  APP_NAME = Raccoon Test
  APP_VERSION = 2.0.0
  MAX_RETRIES = 3
  TIMEOUT = 5000
  DEBUG = true
  LogLevel.Info = 1
  Config.appName = Raccoon Test
  ✓ Multiple constants import working

Test 9: Re-exports
  reSum(8, 12) = 20
  product(5, 6) = 30
  divide(100, 5) = 20
  MODULE_NAME = ReExport Module
  ✓ Re-exports working

Test 10: Standard Library Imports
  Math.sqrt(144) = 12
  Math.pow(2, 8) = 256
...
Test 11: Mixed Import Styles
  Multiple import styles coexist: ✓
  - Named imports: ✓
  - Aliased imports: ✓
  - Namespace imports: ✓
  - Default imports: ✓
...
Test 12: Using Imported Types
  processCalculator result: 30
  ✓ Imported types in function signatures working

Test 13: Complex Operations with Imported Classes
  Triangle perimeter: 12
  ✓ Complex operations with imports working

==================================================
ALL ES MODULES TESTS PASSED!
==================================================
...
Features Tested:
  ...
  ✓ Variable/constant exports/imports
...
Running test: .\tests\test_future_extended_api.rcc
=== Test 1: Future.allSettled() - Todos resueltos ===
AllSettled con éxitos: [{ status: fulfilled, value: 1 }, { value: 2, status: fulfilled }, { status: fulfilled, value: 3 }]
Primer resultado status: fulfilled
Primer resultado value: 1
...
Combined array: [1, 2, 3, 4, 5, 6]
Spread with literals: [0, 1, 2, 3, 7, 4, 5, 6, 8]
Combined object: { a: 1, c: 3, b: 2, d: 4 }
Override: { x: 1, y: 99 }
Function spread result: 60
✅ All spread operator tests passed
Running test: .\tests\test_map_complete.rcc
...
=== Test 2: Future.allSettled() - Mixto ===
AllSettled mixto: [{ value: 10, status: fulfilled }, { status: rejected, reason: Error en medio }, { status: fulfilled, value: 30 }]
Resultado 1: { value: 10, status: fulfilled }
Resultado 2: { status: rejected, reason: Error en medio }
Resultado 3: { status: fulfilled, value: 30 }
...
Combined array: [1, 2, 3, 4, 5, 6]
Spread with literals: [0, 1, 2, 3, 7, 4, 5, 6, 8]
Combined object: { a: 1, d: 4, c: 3, b: 2 }
Override: { x: 1, y: 99 }
Function spread result: 60
✅ All spread operator tests passed
Running test: .\tests\test_map_complete.rcc
...
Running test: .\tests\test_stdlib_complete.rcc
Running test: .\tests\test_stdlib_demo.rcc
Running test: .\tests\test_string_stdlib.rcc
=== Testing String Stdlib ===
...
Testing starts_with_any / ends_with_any:
  starts_with_any('hello world', prefixes): true
  starts_with_any('goodbye', prefixes): false
  ends_with_any('file.txt', suffixes): true
  ends_with_any('file.js', suffixes): false

All string stdlib tests completed!
Running test: .\tests\test_sugar_types.rcc
=== Sugar Types Test ===
...
=== Test 2: Future.allSettled() - Mixto ===
AllSettled mixto: [{ status: fulfilled, value: 10 }, { status: rejected, reason: Error en medio }, { status: fulfilled, value: 30 }]
Resultado 1: { status: fulfilled, value: 10 }
Resultado 2: { status: rejected, reason: Error en medio }
Resultado 3: { status: fulfilled, value: 30 }
...
Combined array: [1, 2, 3, 4, 5, 6]
Spread with literals: [0, 1, 2, 3, 7, 4, 5, 6, 8]
Combined object: { b: 2, d: 4, a: 1, c: 3 }
Override: { y: 99, x: 1 }
Function spread result: 60
✅ All spread operator tests passed
Running test: .\tests\test_map_complete.rcc
...
Running test: .\tests\test_future_extended_api.rcc
=== Test 1: Future.allSettled() - Todos resueltos ===
AllSettled con éxitos: [{ status: fulfilled, value: 1 }, { value: 2, status: fulfilled }, { value: 3, status: fulfilled }]
Primer resultado status: fulfilled
Primer resultado value: 1
...
Combined array: [1, 2, 3, 4, 5, 6]
Spread with literals: [0, 1, 2, 3, 7, 4, 5, 6, 8]
Combined object: { d: 4, c: 3, a: 1, b: 2 }
Override: { x: 1, y: 99 }
Function spread result: 60
✅ All spread operator tests passed
Running test: .\tests\test_map_complete.rcc
...
Running test: .\tests\test_future_extended_api.rcc
=== Test 1: Future.allSettled() - Todos resueltos ===
AllSettled con éxitos: [{ value: 1, status: fulfilled }, { status: fulfilled, value: 2 }, { status: fulfilled, value: 3 }]
Primer resultado status: fulfilled
Primer resultado value: 1

=== Test 2: Future.allSettled() - Mixto ===
AllSettled mixto: [{ value: 10, status: fulfilled }, { reason: Error en medio, status: rejected }, { status: fulfilled, value: 30 }]
Resultado 1: { value: 10, status: fulfilled }
Resultado 2: { reason: Error en medio, status: rejected }
Resultado 3: { status: fulfilled, value: 30 }
...
Combined array: [1, 2, 3, 4, 5, 6]
Spread with literals: [0, 1, 2, 3, 7, 4, 5, 6, 8]
Combined object: { c: 3, d: 4, a: 1, b: 2 }
Override: { y: 99, x: 1 }
Function spread result: 60
✅ All spread operator tests passed
Running test: .\tests\test_map_complete.rcc
...
[19] SPECIAL OPERATORS & EXPRESSIONS
  ...
  ✓ Typeof: defined
  ✓ Spread in arrays: [1, 2, 3, 4, 5]
  ✓ Spread in objects: { a: 1, b: 2, c: 3 }
  ✓ Spread in calls: 6

[20] EDGE CASES & COMPLEX SCENARIOS
  ✓ Deeply nested: 5.25
  ✓ Complex inference: { y: { z: nested }, x: [1, 2, 3] }
  ✓ Closure: 55
  ✓ Method chaining: 16
  ✓ Mixed operations: 7.5
=== Testing Switch/Case ===
