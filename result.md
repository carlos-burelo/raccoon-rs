...
✅ Try-catch blocks
null
Running test: .\tests\ffi_example.rcc
=== Ejemplo de FFI en Raccoon ===

1. Cargando biblioteca matemática del sistema.
   ✓ Biblioteca cargada exitosamente

2. Registrando funciones FFI...
   ✓ Funciones registradas

3. Llamando funciones nativas...
   abs(-42) = null
   sqrt(16.0) = null

✓ FFI funcionando correctamente!

4. Ejemplo de sintaxis declarativa:
   (Esta sintaxis aún no está implementada, pero muestra la visión)
null
null
...
FFI imported successfully!
FFI: class FFI
FFIType: <enum FFIType>
null
...
✓ GET request successful!
  Status: 200
✓ isOk() helper works correctly
✓ Object with string literal keys: { age: 25, name: Carlos, Content-Type: application/json }

All tests passed!
null
Running test: .\tests\test_http_simple.rcc
Testing HTTP with default import...
Response: { body: null, headers: Map { access-control-allow-origin: *, cache-control: public, max-age=0, must-revalidate, etag: "a096f8b2a3cc43cd18ec5f9eb5ebd7ba", server: Vercel, content-type: text/html; charset=utf-8, age: 0, content-disposition: inline, content-length: 17874, date: Sat, 25 Oct 2025 01:47:26 GMT, x-vercel-cache: HIT, x-vercel-id: sfo1::5fghq-1761356846248-47c67e610966, accept-ranges: bytes, last-modified: Sat, 25 Oct 2025 01:47:26 GMT, strict-transport-security: max-age=63072000 }, url: https://coatl.in/, status: 200, statusText: OK }
...
�Desea terminar el trabajo por lotes (S/N)? Running test: .\tests\arrow_functions_demo.rcc
=== ARROW FUNCTIONS AS PARAMETERS ===
...
✓ GET request successful!
  Status: 200
✓ isOk() helper works correctly
✓ Object with string literal keys: { name: Carlos, age: 25, Content-Type: application/json }

All tests passed!
null
Running test: .\tests\test_http_simple.rcc
Testing HTTP with default import...
Response: { status: 200, statusText: OK, body: null, headers: Map { accept-ranges: bytes, etag: "a096f8b2a3cc43cd18ec5f9eb5ebd7ba", access-control-allow-origin: *, last-modified: Sat, 25 Oct 2025 01:47:26 GMT, server: Vercel, strict-transport-security: max-age=63072000, content-disposition: inline, x-vercel-id: sfo1::5rzxw-1761357504812-0d39cdd916a7, age: 658, cache-control: public, max-age=0, must-revalidate, content-length: 17874, x-vercel-cache: HIT, date: Sat, 25 Oct 2025 01:58:24 GMT, content-type: text/html; charset=utf-8 }, url: https://coatl.in/ }
...
=== Testing std:console module ===
Hello from std:console!
...
sin(PI/2) = 1
cos(0) = 1
random() = 0.8794209779233931

=== Testing std:string module ===
...
Testing factorial(10): 3628800
Testing factorial(20): 2432902008176640000
...
null
Running test: .\tests\test_stdlib_enum.rcc
TestEnum: <enum TestEnum>
TestClass: class TestClass
Test!
null
Running test: .\tests\test_stdlib_modules.rcc
Running test: .\tests\test_std_library.rcc
╔═══════════════════════════════════════════════╗
║   Raccoon Standard Library - Module System   ║
╚═══════════════════════════════════════════════╝

[1] Módulo std:console - Salida formateada
   → Información normal

[2] Módulo std:math - Constantes matemáticas
   Math.PI = 3.141592653589793
   2π = 6.283185307179586

[3] Módulo std:math - Funciones básicas
   Número: -15.75
   abs(-15.75) = 15.75
   floor(-15.75) = -15.75
   ceil(-15.75) = -15.75
...
[4] Módulo std:math - Funciones trigonométricas
   Ángulo: π/4
   sin(π/4) = 0.7071067811865476
   cos(π/4) = 0.7071067811865476

[5] Aplicación: Teorema de Pitágoras
   Catetos: a = 3 , b = 4
   Hipotenusa: c = 5

[6] Módulo std:string - Transformaciones de texto
   Original:   Raccoon Programming Language  
   Uppercase:   RACCOON PROGRAMMING LANGUAGE  
   Lowercase:   raccoon programming language  
   Trimmed: Raccoon Programming Language

[7] Módulo std:string - Procesamiento de texto
   CSV: manzana,naranja,plátano,uva
   Frutas separadas: [manzana, naranja, plátano, uva]

[8] Combinando std:math y std:string
...
Running test: .\tests\test_http_simple.rcc
Testing HTTP with default import...
Response: { body: null, status: 200, headers: Map { accept-ranges: bytes, content-disposition: inline, cache-control: public, max-age=0, must-revalidate, content-length: 17874, content-type: text/html; charset=utf-8, date: Sat, 25 Oct 2025 03:17:44 GMT, strict-transport-security: max-age=63072000, x-vercel-cache: HIT, x-vercel-id: sfo1::dklwt-1761362264117-31f5e7c78c15, age: 5417, etag: "a096f8b2a3cc43cd18ec5f9eb5ebd7ba", access-control-allow-origin: *, last-modified: Sat, 25 Oct 2025 01:47:26 GMT, server: Vercel }, url: https://coatl.in/, statusText: OK }
...
NAME = Test
null
Running test: .\tests\test_stdlib_decorators.rcc
abs(-5.5) = 5.5
max(10, 20) = 20
min(10, 20) = 10
clamp(15, 10, 20) = 15
