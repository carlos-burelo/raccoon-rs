/// ReadonlyType - Readonly type handler with metadata system (compile-time only)
...
// ============================================================================
// ReadonlyType - Readonly type handler (compile-time only)
// ============================================================================
...
impl ReadonlyType {
    ...
    pub fn metadata() -> TypeMetadata {
        TypeMetadata::new("readonly", "Readonly type (compile-time only)")
    }
}
...
impl TypeHandler for ReadonlyType {
    ...
    fn call_instance_method(
        ...
        Err(method_not_found_error("readonly", method, position, file))
    }
