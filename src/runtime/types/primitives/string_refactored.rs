/// Refactored StrType using helpers and metadata system
...
pub struct StrTypeRefactored;

impl StrTypeRefactored {
...
#[async_trait]
impl TypeHandler for StrTypeRefactored {
...
mod tests {
    ...
    #[test]
    fn test_metadata() {
        let metadata = StrTypeRefactored::metadata();
